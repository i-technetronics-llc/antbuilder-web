...
const Nav = ({ inverse }: Props) => {
  ...
  const containerClasses = clsx(
    ...
    "flex-col items-center z-20 lg:z-auto justify-center lg:flex lg:flex-row text-center lg:text-left lg:justify-between lg:static space-y-4 lg:space-y-0 space-x-0 lg:space-x-12 top-0 w-screen lg:h-auto lg:w-auto h-screen",
    {
      ...
      "animate-out slide-out-to-right-full pointer-events-none fill-mode-forwards duration-300":
        navOpened !== undefined && !navOpened,
    }
  );
  ...
  return (
    <nav className=" max-w-[1248px] m-auto p-[16px] flex items-center justify-between">
      ...
      <div className={`${containerClasses}`}>
        ...
        <Link href="https://app.antbuilder.tech/auth/signin">
      ...
      <div className="flex items-center justify-between gap-[16px]">
        ...
        <Link href="https://app.antbuilder.tech/auth/booking-information">
      ...
      <button
        ...
        className={`lg:hidden font-bold text-2xl z-30 ${
          !inverse ? "text-primary" : "text-trueGray-500"
        }`}
