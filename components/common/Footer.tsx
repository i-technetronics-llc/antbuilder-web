...
export default function Footer() {
    ...
    return (
        <Container className="mt-10 lg:mt-40">
            <div className="grid grid-cols-1 mb-10 lg:mb-16 pt-10 gap-10 lg:gap-0 lg:border-t border-[#D9D9D9] lg:grid-cols-12 lg:justify-items-end">
                <div className="lg:col-start-1 lg:col-end-10 lg:justify-self-start">
                    <Logo />
