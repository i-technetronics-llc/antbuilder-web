      ...
      <div className="flex flex-col lg:flex-row justify-between mb-10 lg:mb-16 pt-10 lg:border-t border-[#D9D9D9]">
        <div className="mb-10 lg:mb-0">
          ...
          <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400 text-[16px]">
            Launch apps faster and cheaper. Connect with expert developers,
            access customizable code modules, and enjoy dedicated support.
            Experience efficient app development with regular updates.
          </div>
        </div>

        <div className="flex flex-col lg:flex-row space-y-10 lg:space-y-0 space-x-0 lg:space-x-14">
          <div className="flex flex-col">
            <h4 className={`${mukta.className} text-lg lg:text-xl font-bold`}>
              Company
            </h4>
            {navigation.map((item, index) => (
              <Link
                key={index}
                href={item.href}
                className="w-full py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-blue-500 focus:text-blue-500 focus:bg-blue-100 focus:outline-none dark:focus:bg-trueGray-700"
              >
                {item.value}
              </Link>
            ))}
...
const Twitter = ({ size = 24 }) => (
  <svg
    ...
    baseProfile="basic"
  >
    <path d="M38,42H10c-2.209,0-4-1.791-4-4V10c0-2.209,1.791-4,4-4h28	c2.209,0,4,1.791,4,4v28C42,40.209,40.209,42,38,42z" />
    <path
      fill="#fff"
