        ...
        <Container>
          ...
          <section className="text-center mt-10 lg:mt-[48px] bg-no-repeat bg-center bg-cover bg-[url('/images/homebg.svg')]">
            <div className=" text-trueGray-300">
              <h3 className="text-4xl lg:text-5xl font-semibold text-trueGray-500 ">
                Build your Apps
              </h3>

              <h1
                className={`text-[64px] ${millik.className} text-trueGray-500 mt-[16px] leading-tight lg:leading-normal`}
              >
                Faster and Better
              </h1>
              ...
              <p className="text-2xl mt-[27px]">
                Launch
                <span className={`text-primary-600 ${openSans.className} mx-1`}>
                  5x Faster
                </span>{" "}
                &
                <span className={`text-primary-600 ${openSans.className} mx-1`}>
              ...
              <p className="text-2xl mt-[12px] font-medium">
                Test your builds biweekly with our data-driven app development
                platform
              </p>
            </div>

            <Link
              href="https://app.antbuilder.tech/auth/booking-information"
              target="_blank"
            >
              <Button
